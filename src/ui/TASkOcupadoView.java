...
public class TASkOcupadoView extends JFrame implements Observer, Notificator {

    public static final String LIGHT = "com.formdev.flatlaf.themes.FlatMacLightLaf";
    public static final String DARK = "com.formdev.flatlaf.themes.FlatMacDarkLaf";
    public static final String SIMPLE = "javax.swing.plaf.nimbus.NimbusLookAndFeel";
    public static final String CLASSIC = "javax.swing.plaf.metal.MetalLookAndFeel";
    public static final String UGLY = "com.sun.java.swing.plaf.windows.WindowsLookAndFeel";
    ...
    private void initComponents() {
        ...
        taskTextField.setToolTipText("Enter task description here.");
        taskTextField.setCursor(new java.awt.Cursor(java.awt.Cursor.TEXT_CURSOR));
        ...
        memberTextField.setToolTipText("Enter member name here.");
        memberTextField.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                memberTextFieldFocusGained(evt);
            }
        });
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(taskTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 304, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(memberTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 308, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void asignTaskButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_asignTaskButtonActionPerformed
        taskOcupadoController.assignTask(taskTextField.getText(), memberTextField.getText());
        System.out.println(taskTextField.getText() + " " + memberTextField.getText());
    ...
    private void taskTextFieldFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_taskTextFieldFocusGained
        if (taskTextField.getText().equals("")) {
            taskTextField.setText("Enter task here");
        }
        taskTextField.selectAll();
    }//GEN-LAST:event_taskTextFieldFocusGained

    private void memberTextFieldFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_memberTextFieldFocusGained
        if (memberTextField.getText().equals("")) {
            memberTextField.setText("Enter member here");
        }
        memberTextField.selectAll();
    }//GEN-LAST:event_memberTextFieldFocusGained
